          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="<?php echo base_url('clientes/show'); ?>"><i class="fa fa-circle-o"></i> Clientes</a></li>
                 <li class=""><a href="<?php echo base_url('usuarios/show'); ?>"><i class="fa fa-circle-o"></i> Usuarios</a></li>          
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
